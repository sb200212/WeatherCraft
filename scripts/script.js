...
cityInput.addEventListener("keyup", function(event)
{
  if(event.key === "Enter")
  {
    ...
    var apiKey = "48be1729b35404bb063d109c96e9e1b1"; // Default
    var unit = "metric";
    ...
    if(cityInputValue != "")
    {
      async function getWeather()
      {
        ...
        if(data.message != "city not found" && data.cod != "404")
        {
          ...
          // From here, you compare the weather condition and select the relevant image array.
           // From here, you compare the weather ID and select the relevant image array.
           if (weatherId >= 200 && weatherId < 600) { // Thunderstorm, Rain, Drizzle
